...
# for local dev: cookiecutter ../../  --no-input  --overwrite-if-exists  dockerize="runserver" debug="y" 
cookiecutter ../../  --no-input  --overwrite-if-exists  dockerize="runserver" debug="y" travis_ci="y"
